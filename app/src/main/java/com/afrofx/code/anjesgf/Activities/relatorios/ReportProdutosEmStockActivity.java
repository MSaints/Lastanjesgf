...
public class ReportProdutosEmStockActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(id == R.id.partilhaVendas){
            ...
            if(fileWithinMyDir.exists()) {
                ...
                intentShareFile.putExtra(Intent.EXTRA_SUBJECT, "ECONTA - Produtos em stock");
    ...
    public void imprimeVendas() {
        ...
        if (success) {
            path = folder + "/Produtos em Stock" + timeStamp + ".pdf";
        } else {
        ...
        try {
            ...
            Paragraph p0 = new Paragraph("Relatorio dos Produtos em Stock", chapterFont);

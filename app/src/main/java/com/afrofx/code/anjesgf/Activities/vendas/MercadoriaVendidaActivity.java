...
import com.afrofx.code.anjesgf.Recyclers.RecyclerMercadoriaVendida;
...
public class MercadoriaVendidaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar toolbar =  findViewById(R.id.toolbarMercadoriasVendidas);
        ...
        totalAmount = findViewById(R.id.vendasTotal);


        LinearLayout valorTotalVendas = findViewById(R.id.valorTotalVendas);
        valorTotalVendas.setBackgroundColor(Constant.color);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            startActivity(new Intent(MercadoriaVendidaActivity.this, VendasActivity.class));
            finish();
            return true;
        }
    ...
    public void imprimeVendas() {
        ...
        if (success) {
            path = folder + "/Registo de Vendas" + timeStamp + ".pdf";
        } else {
        ...
        try {
            ...
            Paragraph p0 = new Paragraph("Registo de vendas diárias", chapterFont);

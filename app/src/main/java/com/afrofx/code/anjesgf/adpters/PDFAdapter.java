...
import com.afrofx.code.anjesgf.Activities.LoginActivity;
import com.afrofx.code.anjesgf.Activities.RelatoriosGeradosActivity;
import com.afrofx.code.anjesgf.Activities.VisualizadorPDFActivity;
...
public class PDFAdapter extends RecyclerView.Adapter<PDFAdapter.ViewHolder> {
    ...
    public PDFAdapter(RelatoriosGeradosActivity context, ArrayList<File> al_pdf) {
    ...
    public PDFAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        PDFAdapter.ViewHolder viewHolder = new PDFAdapter.ViewHolder(v);
        return viewHolder;
    }
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        Date lastModDate = new Date(al_pdf.get(position).lastModified());

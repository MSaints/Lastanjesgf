...
public class StockModel {
    ...
    private double produto_quantidade, produto_preco_compra,
            produto_quanti_minima, produto_preco_venda, produto_quanti_unidade;
    ...
    public StockModel(int id_produto, double produto_quantidade, double produto_preco_venda, String produto_nome, String categoria) {
    ...
    public StockModel(int id_categoria, int id_unidade, int id_fornecedor, double produto_quantidade,
                      double produto_preco_compra, double produto_quanti_minima, double produto_preco_venda,
                      double produto_quanti_unidade, String produto_nome) {
        ...
        this.produto_preco_venda = produto_preco_venda;
        this.produto_quanti_unidade = produto_quanti_unidade;
        this.produto_nome = produto_nome;
    }

    public StockModel(int id_produto, int id_categoria, int id_unidade, int id_fornecedor,
                      double produto_quantidade, double produto_preco_compra, double produto_quanti_minima,
                      double produto_preco_venda, double produto_quanti_unidade, String produto_nome,
                      String produto_data_registo) {
        this.id_produto = id_produto;
        this.id_categoria = id_categoria;
        this.id_unidade = id_unidade;
        this.id_fornecedor = id_fornecedor;
    ...
    public double getProduto_quanti_unidade() {
        return produto_quanti_unidade;
    }

    public void setProduto_quanti_unidade(double produto_quanti_unidade) {
        this.produto_quanti_unidade = produto_quanti_unidade;
    }
